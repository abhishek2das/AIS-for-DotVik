...
function adminPanel(){$("#admin_slider").trigger("to.owl.carousel", [0, 0, true]);}
function MobileClick() {$("#MobileSlider").trigger("to.owl.carousel", [0, 0, true]);}
function reportsPanel() {$("#reports_slide").trigger("to.owl.carousel", [0, 0, true]);}
